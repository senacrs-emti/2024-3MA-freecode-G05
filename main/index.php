...
<section>
    ...
    <div class="partidas_left">
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            ?>
            <div class="barra">
                <img class="times" src="./img/logo/<?php echo $row["EscudoTimeCasa"];?>" alt=""><p><?php echo $row["SiglaTimeCasa"];?></p>
                <p>X</p>
                <p><?php echo $row["SiglaTimeVis"];?></p><img class="times" src="./img/logo/<?php echo $row["EscudoTimeVis"];?>" alt="">
            </div>
            <?php
            }
        }
